...
const Learn = (props) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={props.color} fill="none" {...props}>
    ...
    <Path d="M7.49199 19H7.50098" stroke="currentColor" strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    ...
    <Path d="M17.5703 10.5L16.9453 9.25M12.5703 10.5L13.1953 9.25M13.1953 9.25L14.9989 5.5L16.9453 9.25M13.1953 9.25L16.9453 9.25" stroke="currentColor" strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);
