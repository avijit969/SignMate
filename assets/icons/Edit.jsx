...
const Edit02Icon = (props) => (
    <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={props.color} fill="none" {...props}>
        ...
        <Path d="M13 4L20 11" stroke="currentColor" strokeWidth={props.strokeWidth} strokeLinejoin="round" />
        <Path d="M14 22L22 22" stroke="currentColor" strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
);
